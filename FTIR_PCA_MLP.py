...
if __name__ == "__main__":
    ...
    plot_confusion_matrix(MLPcm, PN, 'PCA-MLP')
    SVMcm = confusion_matrix(y_test, SVMPre)
    plot_confusion_matrix(SVMcm, PN, 'PCA-SVM')
    KNNcm=confusion_matrix(y_test, KNNPre)
    plot_confusion_matrix(KNNcm, PN, 'PCA-KNN')
    RFcm = confusion_matrix(y_test, RFPre)
    plot_confusion_matrix(RFcm, PN, 'PCA-RF')
    print('MLP:'+str(modelMLP.score(x_test,y_test)))
    print('SVM:'+str(modelSVM.score(x_test,y_test)))
    print('KNN:' + str(modelKNN.score(x_test, y_test)))
    print('RF:' + str(modelRF.score(x_test, y_test)))
